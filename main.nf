...
params.exome="";
if(params.exome){
  model=file("s3://biocentric-deepvariant/models/exome");
}
else{
...
if(!("nofasta").equals(params.fasta)){
  ...
  fasta=file("s3://biocentric-deepvariant/genomes/h38/GRCh38.p10.genome.fa");
  fai=file("s3://biocentric-deepvariant/genomes/h38/GRCh38.p10.genome.fa.fai");
  fastagz=file("s3://biocentric-deepvariant/genomes/h38/GRCh38.p10.genome.fa.gz");
  gzfai=file("s3://biocentric-deepvariant/genomes/h38/GRCh38.p10.genome.fa.gz.fai");
  gzi=file("s3://biocentric-deepvariant/genomes/h38/GRCh38.p10.genome.fa.gz.gzi");
}
else if(params.test){
  fasta=file("s3://biocentric-deepvariant/input/ucsc.hg19.chr20.unittest.fasta");
  fai=file("s3://biocentric-deepvariant/input/ucsc.hg19.chr20.unittest.fasta.fai");
  fastagz=file("s3://biocentric-deepvariant/input/ucsc.hg19.chr20.unittest.fasta.gz");
  gzfai=file("s3://biocentric-deepvariant/input/ucsc.hg19.chr20.unittest.fasta.gz.fai");
  gzi=file("s3://biocentric-deepvariant/input/ucsc.hg19.chr20.unittest.fasta.gz.gzi");
}
else if(params.hs37d5){
  fasta=file("s3://biocentric-deepvariant/genomes/hs37d5/hs37d5.fa");
  fai=file("s3://biocentric-deepvariant/genomes/hs37d5/hs37d5.fa.fai");
  fastagz=file("s3://biocentric-deepvariant/genomes/hs37d5/hs37d5.fa.gz");
  gzfai=file("s3://biocentric-deepvariant/genomes/hs37d5/hs37d5.fa.gz.fai");
  gzi=file("s3://biocentric-deepvariant/genomes/hs37d5/hs37d5.fa.gz.gzi");
}
else if(params.grch37primary){
  fasta=file("s3://biocentric-deepvariant/genomes/GRCh37.dna.primary/Homo_sapiens.GRCh37.dna.primary_assembly.fa");
  fai=file("s3://biocentric-deepvariant/genomes/GRCh37.dna.primary/Homo_sapiens.GRCh37.dna.primary_assembly.fa.fai");
  fastagz=file("s3://biocentric-deepvariant/genomes/GRCh37.dna.primary/Homo_sapiens.GRCh37.dna.primary_assembly.fa.gz");
  gzfai=file("s3://biocentric-deepvariant/genomes/GRCh37.dna.primary/Homo_sapiens.GRCh37.dna.primary_assembly.fa.gz.fai");
  gzi=file("s3://biocentric-deepvariant/genomes/GRCh37.dna.primary/Homo_sapiens.GRCh37.dna.primary_assembly.fa.gz.gzi");
}
else if(params.hg19chr20 ){
  fasta=file("s3://biocentric-deepvariant/genomes/hg19chr20/chr20.fa");
  fai=file("s3://biocentric-deepvariant/genomes/hg19chr20/chr20.fa.fai");
  fastagz=file("s3://biocentric-deepvariant/genomes/hg19chr20/chr20.fa.gz");
  gzfai=file("s3://biocentric-deepvariant/genomes/hg19chr20/chr20.fa.gz.fai");
  gzi=file("s3://biocentric-deepvariant/genomes/hg19chr20/chr20.fa.gz.gzi");
}
else if(params.hg19 ){
  fasta=file("s3://biocentric-deepvariant/genomes/hg19/hg19.fa");
  fai=file("s3://biocentric-deepvariant/genomes/hg19/hg19.fa.fai");
  fastagz=file("s3://biocentric-deepvariant/genomes/hg19/hg19.fa.gz");
  gzfai=file("s3://biocentric-deepvariant/genomes/hg19/hg19.fa.gz.fai");
  gzi=file("s3://biocentric-deepvariant/genomes/hg19/hg19.fa.gz.gzi");
}
...
if(params.test){
    params.bam_folder="s3://nextflow-bucket/deepvariant"
}
